...
#define USBD_MANUFACTURER_STRING        "Geek_Lite_Board"
#define USBD_PRODUCT_HS_STRING          "Geek_Lite_Board"
#define USBD_PRODUCT_FS_STRING          "Geek_Lite_Board"
#define USBD_CONFIGURATION_HS_STRING    "Geek_Lite_Board"
#define USBD_INTERFACE_HS_STRING        "Geek_Lite_Board"
#define USBD_CONFIGURATION_FS_STRING    "Geek_Lite_Board"
#define USBD_INTERFACE_FS_STRING        "Geek_Lite_Board"
/**
  * @}
  */
...
__ALIGN_BEGIN uint8_t USBD_DeviceDesc[USB_SIZ_DEVICE_DESC] __ALIGN_END = {
  ...
  0x001,          /* Index of serial number string ¹ÊÒâÐÞ¸ÄÎª0x001*/
